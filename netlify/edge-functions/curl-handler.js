...
function neofetchPage() {
  return `
${c.green}        #####${c.reset}           ${c.peach}${c.bold}muteeullah${c.reset}${c.overlay}@${c.reset}${c.blue}portfolio${c.reset}
${c.green}       #######${c.reset}          ${c.overlay}──────────────────────────────────────${c.reset}
${c.green}       ##O#O##${c.reset}          ${c.sapphire}OS${c.reset}:       SRE v7.0 (Mumbai Edition)
${c.green}       #######${c.reset}          ${c.sapphire}Host${c.reset}:     Lenovo ThinkCentre | Proxmox VE
${c.green}     ###########${c.reset}        ${c.sapphire}Kernel${c.reset}:   Infrastructure-as-Code
${c.green}    #############${c.reset}       ${c.sapphire}Uptime${c.reset}:   7+ years in production
${c.green}   ###############${c.reset}      ${c.sapphire}Packages${c.reset}: Terraform, Ansible, K8s, Docker
${c.green}   ################${c.reset}     ${c.sapphire}Shell${c.reset}:    bash/zsh + too many aliases
${c.green}   ################${c.reset}     ${c.sapphire}Terminal${c.reset}: Ghostty
${c.green}   ################${c.reset}     ${c.sapphire}Theme${c.reset}:    Catppuccin Mocha
${c.green}    ####  ########${c.reset}      ${c.sapphire}CPU${c.reset}:      Cost Optimization Engine v3
${c.green}     ##    ######${c.reset}       ${c.sapphire}Memory${c.reset}:   $100K+ saved / year
${c.green}            ####${c.reset}        ${c.sapphire}GPU${c.reset}:      Zero-Downtime Migration Accel.
${c.green}             ##${c.reset}         ${c.sapphire}Disk${c.reset}:     0 incidents (PagerDuty: defunct)
                        ${c.sapphire}Network${c.reset}:  AWS <-> GCP <-> On-Prem <-> Homelab
                        ${c.sapphire}Locale${c.reset}:   Mumbai, IN

                        ${c.red}███${c.peach}███${c.yellow}███${c.green}███${c.blue}███${c.mauve}███${c.reset}
...
${c.blue}╰────────────────────────────────────────────────────────────────────────╯${c.reset}
   ...
   ${c.green}${c.bold}curl -L muteeullah.b0lt.foo/neofetch${c.reset}
   ${c.overlay}└─${c.reset} ${c.dim}System info, neofetch style${c.reset}
